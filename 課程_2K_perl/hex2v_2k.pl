...
open (OUTPUTFILE,">".$filename_w) || 
 ...
 #Print head
  print OUTPUTFILE "module Program_Rom(Rom_data_out, Rom_addr_in);\n\n";
  print OUTPUTFILE "//---------\n";
  print OUTPUTFILE "    output [13:0] Rom_data_out;\n";
  print OUTPUTFILE "    input [10:0] Rom_addr_in; \n";
  print OUTPUTFILE "//---------\n";
  print OUTPUTFILE "    \n";
  print OUTPUTFILE "    reg   [13:0] data;\n";
  print OUTPUTFILE "    wire  [13:0] Rom_data_out;\n";
  print OUTPUTFILE "    \n";
  print OUTPUTFILE "    always @(Rom_addr_in)\n";
